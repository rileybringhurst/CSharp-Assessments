...
{
    // Change filepaths or tax rates here
    ...
    class Program
    {
        ...
        static double calculateGrossForHourly(double payRate, int hoursWorked)
        {
            ...
            if (hoursWorked > 90)
            {
                gross += (hoursWorked - 90) * 1.75 * payRate;
                hoursWorked -= hoursWorked - 90;
            }

            if (hoursWorked > 80)
            {
                gross += (hoursWorked - 80) * 1.5 * payRate;
                hoursWorked -= hoursWorked - 80;
            }
